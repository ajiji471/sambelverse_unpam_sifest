...
require_once('koneksi.php'); // Menggunakan koneksi dari file koneksi.php
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (
        isset($data['user_id'], $data['pesanan'], $data['kategori'], $data['total_tagihan'], $data['deposit_id'], $data['keterangan']) &&
        ...
        try {
            ...
            $stmt = $pdo->prepare("
                INSERT INTO tbl_invoices (user_id, pesanan, kategori, total_tagihan, deposit_id, keterangan)
                VALUES (:user_id, :pesanan, :kategori, :total_tagihan, :deposit_id, :keterangan)
            ");
