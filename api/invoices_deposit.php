...
if (isset($_GET['user_id'])) {
    ...
    try {
        // Query untuk mendapatkan deposit berdasarkan user_id yang terakhir diperbarui
        $stmt = $conn->prepare("SELECT deposit_id FROM tbl_invoices WHERE user_id = :user_id ORDER BY purchase_date DESC LIMIT 1");
