...
const AllMenuForHome = () => {
  ...
  <h1 className="text-2xl font-bold text-center mb-6">All Menu</h1>
  {menus.length > 0 ? (
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6 -z-50">
      {menus.map((menu) => (
        <div
        ...
        >
          ...
          <div className="overflow-hidden">
            ...
            <div className="absolute top-2 left-2 bg-black bg-opacity-60 text-white text-sm font-semibold px-2 py-1 rounded">
